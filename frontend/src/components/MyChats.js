...
const MyChats = ({ fetchAgain }) => {
  ...
  return (
    ...
    borderRadius="lg"
    borderWidth="1px"
    boxShadow="md" // Adding a subtle box shadow
  >
    <Box
      paddingBottom={3}
      paddingLeft={3}
    ...
    >
      ...
      <GroupChatModal>
        <Button
          ...
          rightIcon={<AddIcon />}
          variant="outline" // Using outline variant for better contrast
        >
          New Group Chat
        </Button>
      </GroupChatModal>
    ...
    <Box
      ...
      height="100%"
      borderRadius="lg"
      overflowY="auto" // Using auto to show scroll bar only when necessary
    >
      {chats ? (
        <Stack spacing={2}>
          {chats.map((chat) => (
